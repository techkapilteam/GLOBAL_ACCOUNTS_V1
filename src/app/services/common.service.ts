...
if (doc.getNumberOfPages() === 1) {
  ...
  doc.line(10, 45, pageWidth - lMargin - rMargin, 45);
        ...
        //   doc.setFontSize(15);
        //   if (kapil_logo) {
        //     // Defensive check in case logo is missing
        ...
        //   // Defensive substring (in case address is shorter)
        //   const address1 = address.length > 115 ? address.substr(0, 115) : address;
        //   const address2 = address.length > 115 ? address.substring(115) : '';

        //   // Using string alignment directly (jsPDF expects string)
        //   doc.text(address1, 110, 15, { align: 'center' });
        //   if (address2) {
        //     doc.text(address2, 110, 18);
        //   }
        ...
        //   doc.setDrawColor(0, 0, 0);
        //   // Use margins consistently for line width
