...
export class AddFotmToMenuService {
    ...
    saveParentModuleTitle(data:any) :any{
    ...
    saveSubModuleTitle(data:any):any {
    ...
    CheckDuplicatesSubModule(Modulename:any, Submodulename:any) :any{
        try {
