...
export class OnlineReceiptsComponent implements OnInit {
  ...
  constructor(private commonservice: CommonService, private chittransactionservice: ChitTransactionsService, private _fb: FormBuilder, private datepipe: DatePipe) {
  ...
  ngOnInit(): void {
    // this.companydetails=  JSON.parse(sessionStorage.setItem('companydetails'));
    ...
    this.onlineprocessingform = this._fb.group({
      ...
      Cashfreefromdate: [new Date(), Validators.required],
  ...
  getmonth() {
    ...
    newmonth.setDate(newmonth.getDate() - Number(days));
  ...
  getPaytmAutoreceiptCount() {
    ...
    let paytmreceiptdate = this.commonservice.getFormatDateNormal(this.onlineprocessingform.get('date2')?.value);
    this.chittransactionservice.getPaytmAutoreceiptCount(this.brachid, 'OFFLINE', paytmreceiptdate).subscribe(res => {
      ...
      this.PaytmAutoreceiptCount.forEach((element: any) => {
  ...
  onlineupdatedata(): any {
    ...
    try {
      ...
      if (this.validateonlineForm()) {
        ...
        let fromdate = this.datepipe.transform(this.onlineprocessingform.get('fromdate')?.value, 'dd-MM-yyyy');
        console.log(fromdate)
        // if (this.onlineprocessingform.get('fromdate')?.value) {
        if (fromdate) {
          // fromdate = this.commonservice.getFormatDateNormal(fromdate);
          fromdate = fromdate;
        }
        else {
          fromdate = "null";
  ...
  onlineupdatedataCashfree(): any {
    ...
    try {
      ...
      if (this.validateonlineForm()) {
        ...
        let Cashfreefromdate = this.onlineprocessingform.get('Cashfreefromdate')?.value;
        console.log(Cashfreefromdate)
        if (this.onlineprocessingform.get('Cashfreefromdate')?.value) {
          Cashfreefromdate = this.commonservice.getFormatDateNormal(Cashfreefromdate);
        }
        else {
  ...
  onlineupdate() {
    ...
    // let transdate = this.commonservice.getFormatDateNormal(this.onlineprocessingform.get('fromdate')?.value);
    let transdate = this.datepipe.transform(this.onlineprocessingform.get('fromdate')?.value, 'dd-MM-yyyy');
    this.chittransactionservice.updatestatuspatm(transdate).subscribe((res: any) => {
      this.data = res
  ...
  updatestatusCashfree() {
    ...
    let transdate = this.commonservice.getFormatDateNormal(this.onlineprocessingform.get('Cashfreefromdate')?.value);
    this.chittransactionservice.updatestatusCashfree(transdate).subscribe((res: any) => {
      this.data = res
  ...
  sqldumpeddata(): any {
    try {
      ...
      if (this.validateonlineForm()) {
        ...
        let fromdate1 = this.onlineprocessingform.get('date1')?.value;
        console.log(fromdate1)
        if (this.onlineprocessingform.get('date1')?.value) {
          fromdate1 = this.commonservice.getFormatDateNormal(fromdate1);
        }
        else {
          fromdate1 = "null";
        }
  ...
  showsqldumpeddata() {
    ...
    let transactiondate = this.commonservice.getFormatDateNormal(this.onlineprocessingform.get('date1')?.value);
    this.chittransactionservice.gettransations('OFFLINE', transactiondate).subscribe((json: any) => {
      this.data1 = json
  ...
  paytmreceipt(): any {
    try {
      ...
      if (this.validateonlineForm()) {
        ...
        let fromdate2 = this.onlineprocessingform.get('date2')?.value;
        console.log(fromdate2)
        if (this.onlineprocessingform.get('date2')?.value) {
          fromdate2 = this.commonservice.getFormatDateNormal(fromdate2);
        }
        else {
          fromdate2 = "null";
        }
  ...
  show() {
    ...
    let fromdate = this.commonservice.getFormatDateNormal(this.onlineprocessingform.get('date2')?.value);
    this.chittransactionservice.getpaytmautoreceipt(fromdate, 'GLOBAL').subscribe((json: any) => {
      this.data1 = json
