...
//   GetChequesIssued_Load(bankid: number): void {
...
//         this.modeofreceipt, this._searchText,
...
//   /**
//    * Validates the form and grid state before saving.
...
//   /**
//    * Full payload build for SaveChequesIssued API contract.
//    * Used when the save needs to include the complete API schema
//    * (e.g. from a parent component or extended save flow).
//    */
