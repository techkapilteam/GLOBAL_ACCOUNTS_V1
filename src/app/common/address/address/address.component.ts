...
export class AddressComponent implements OnInit {
  ...
  getCountryDetails(): void {
    ...
    this._contacmasterservice.getcountrys(
  ...
  getSateDetails(countryid: any) {
    // this._contacmasterservice.getstates(countryid).subscribe((json: any) => {
    //   this.stateDetails = json;
    // },
    //   (error: any) => {
  ...
  getDistrictDetails(state_id: any) {
    ...
    //   });
      ...
      this._contacmasterservice.getDistrict(
      this._commonService.getschemaname(),
      state_id
    )
      .subscribe({
